// ── pong-server/game.ts ───────────────────────────────────────────────────
import { GAME_WIDTH, GAME_HEIGHT, PADDLE_H, PADDLE_W, BALL_R, POWER_UPV, POWER_UPB } from './types.js';
import { aiPaddleMove } from './ai/index.js';
export class Game {
    constructor(leftId, rightId /* "AI" for solo */, aiDifficulty = 'medium') {
        this.speed = 400; // ball speed (px/s)
        this.paddleSpeed = 340; // player paddle speed (px/s)
        this.aiSpeed = 100; // base AI paddle speed (px/s)
