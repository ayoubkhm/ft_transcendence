...
exports.broadcastDashboardUpdate = broadcastDashboardUpdate;
exports.default = websocketRoutes;
const WS_OPEN = 1;
// --- WebSocket Connection Management ---
const socketsGroups = new Map(); // groupId -> Set<SocketStream>
const socketToGroups = new Map(); // SocketStream -> Set<groupId>
function joinGroup(connection, groupId) {
...
function leaveGroup(connection, groupId) {
...
async function broadcastTournamentUpdate(server, tournamentId, pgClient) {
...
async function broadcastDashboardUpdate(server, pgClient) {
...
function websocketRoutes(server) {
